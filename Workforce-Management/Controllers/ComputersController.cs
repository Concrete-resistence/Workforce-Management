...
namespace Workforce_Management.Controllers
{
    public class ComputersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ComputerId,ComputerName,ComputerManufacturer,PurchaseDate")] Computer computer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ComputerId,ComputerName,ComputerManufacturer,PurchaseDate")] Computer computer)
        {
            if (ModelState.IsValid)
            {
